...
# IDVAULT
## REDUCING VOTER FRAUD INEFFICIENCIES WITH VERIFIABLE AUDIT TRAILS
...
[XXXXX] GITHUB ACCOUNT (replace with your link)</br>
[X] COURSES TAKEN</br>
...
Another drawback comes from malicious actors attempting to hack elections. Voter data on the blockchain is permanent. Violent extremists may want to access that data. Data silos create targets for attack and voter date is highly valuable. We create obfuscation through our layered approach by organizing the vote counts and auditable information to public blockchain entries, the registeration data to private blockchain entries, and the user id to the wallets. For malicious actors that could compromise segments, auditors would also be able to track the suspicious activity.
...
<div style="width:250px; height:250px">
<img text="IDVT LOGO" src="https://github.com/IDVault-2023/capstone-g2-2023/blob/bf8a7fc92455ce680e4dba48d80d567985a98223/logo/IDVT-logo-color.png" alt="IDVT Full Logo" width="40%" ></i>
</div>
